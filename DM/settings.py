...
SECRET_KEY = "django-insecure-)w(g6de)7#p%&8aa&xxea96fm_3)*wxqpnn7!5*%!n^z+7l3(3"
...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels.layers.InMemoryChannelLayer',  # 可以根据需要选择其他后端，比如 Redis
    },
}
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / 'action/../action/templates']
        ,
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
MEDIA_URL = 'http://127.0.0.1:8000/file/'
